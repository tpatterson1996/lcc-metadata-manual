...
This page will provide a brief overview of required fields for a metadata Project record, for more in-depth information, rationale, and instructions, please see the field's documentation in the [Record](/records.md) section of this manual.
...
![](/assets/projects_pencil_button.png)
