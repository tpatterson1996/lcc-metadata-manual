...
* One or more LCCs co-funds a project with one or more CASCs without distinct sub-parts that could be attributed to either an LCC or CASC.
...
4. Complete the additional metadata requirements for a cofunded project.
...
3. Complete the additional metadata requirements for a cofunded project.
...
_Figure 6: Example of mdEditor entry for Main/Point of Contact for an LCC/CASC co-funded project. Here, the project was a collaboration between the GCP LCC \(lead LCC\), the GCPO LCC, and the South Central CASC._

## Metadata/Metadata Contacts

Include the lead LCC as “publisher.”

Collaborating CASCs \(or other LCCs\) do not need to be listed here.
...
2. Add the funding LCC as the “administrator” in the Other Contacts section \(see Figure 7 example\).**         **

![](https://lh5.googleusercontent.com/FuzsddF2rFu5QQiRYIC7xLYOQrFWwHFoqIIMa0OuODOz52A3oSi1tAUUfh58HTjYmtKohXAGKwWfoKXdRXjol3J-A_zBCl6kddAGBjErEWIfSrSoYAkdmieraFzgSYR3jBwG0q26)_Figure 7: Example of mdEditor entry for an LCC funding allocation. Here, the UMGL LCC administered the USFWS funds. Additional allocations would be added for each LCC that provided funding to the project._

### CASC allocations

1. List the source as U.S. Geological Survey
2. Add the funding CASC as the “administrator” in the Other Contacts section
3. Check the matching funds box \(see Figure 8 example\).
...
_Figure 8: Example of mdEditor entry for a CASC funding allocation. Here, the source is USGS and the CASC is the administrator since the funds did not flow through the LCC or FWS. The matching funds box is checked._**              **
...
1. 1. Manually associate the LCC/CASC project as an“alternate”relationship in theAssociatedtab.

   2. 1. Populate the association type as “alternate”.
...
3. Add an “alternate” association to the CASC ScienceBase item \(see Figure 10 example\).
